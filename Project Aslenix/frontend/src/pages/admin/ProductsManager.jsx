      ...
      >
        ...
        <section className="products-stats-grid">
          {statCards.map((card, index) => (
            ...
            >
              <div className="products-stat-icon">{card.icon}</div>
              <div>
                <p className="products-stat-title">{card.title}</p>
                <h3 className="products-stat-value">{card.value}</h3>
                <span className="products-stat-subtitle">{card.subtitle}</span>
              </div>
            </div>
          ))}
        </section>
            ...
            >
              ...
              >
                ...
                <button
                  ...
                  onClick={editingId ? handleUpdate : addProduct}
                  style={{
                    marginTop: "20px",
                    background: editingId ? "#22c55e" : "#facc15",
                    color: "black",
                    border: "none",
                    padding: "12px 25px",
                    borderRadius: "10px",
                ...
                <tr>
                  <td colSpan="7">
                    <div className="products-empty-state">
                      ...
                      <p>
                        Try adjusting your search or add a new Sudisu Masala
                        product.
                      </p>
                      <button type="button" onClick={openAddProductForm}>
                        Add Product
                      </button>
                    </div>
                  </td>
